...
import { Package, PlusCircle, Trash2, Search, Filter, ShieldAlert, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function StockTab() {
  ...
  const handleDeleteItem = async (id: string) => {
    ...
    try {
      ...
      console.error(err);
      showAlert('Error', 'Failed to delete item from stock.', 'error');
    }
  };
